...
const SearchPage = () => {
  ...
  const [activeFilter, setActiveFilter] = useState<"distance" | "rating" | "studyScore">("distance");
    ...
    <div className="min-h-screen bg-white pb-20">
      ...
      <div className="px-4 py-4 max-w-md mx-auto space-y-4">
        ...
        <div className="flex gap-2">
          ...
          <Button
            variant={activeFilter === "studyScore" ? "default" : "outline"}
            size="sm"
            onClick={() => setActiveFilter("studyScore")}
            className="flex items-center gap-1"
          >
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-medium text-foreground">
              {searchQuery ? `'${searchQuery}' 검색 결과` : "내 주변 카페"} ({searchResults.length}곳)
            </h3>
          </div>
